      ...
      <div className="h-screen w-screen flex justify-center items-center">
         <div className="p-2 w-1/3 border-2 border-gray-600 flex flex-col justify-center items-start">
            ...
            <div className="py-2 px-8 w-full">
               <input 
                  className="border h-10 text-white rounded-md bg-transparent px-2 w-full"
                  placeholder="My Name"
                  type="text"
                  value={name}
            ...
            {error && <p className="text-red-500 px-8 py-2">{error}</p>}
            <div className="flex flex-row justify-center items-center mt-16 w-full">
               <button 
